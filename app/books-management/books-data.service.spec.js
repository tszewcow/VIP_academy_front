describe('booksData service tests', function() {
    ...
    it('should save the book', function() {
        ...
        $httpBackend.expectPOST('http://localhost:9000/services/book').respond(201);
        // when
    ...
    it('should update book', function() {
        ...
        $httpBackend.expectPUT('http://localhost:9000/services/book', book).respond(200);
        // when
    ...
    it('should delete book', function() {
        // given
        var bookId = 1;
        $httpBackend.expectDELETE('http://localhost:9000/services/book/' + bookId).respond(200);
        // when
